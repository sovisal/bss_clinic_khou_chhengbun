...
class EyeExaminationRequest extends FormRequest
{
	...
	public function rules()
	{
		return [
			...
			'image_uper_lide_re' => 'nullable|mimes:jpeg,jpg,png|max:10240',
			'image_uper_lide_le' => 'nullable|mimes:jpeg,jpg,png|max:10240',
			'image_eye_boll_re' => 'nullable|mimes:jpeg,jpg,png|max:10240',
			'image_eye_boll_le' => 'nullable|mimes:jpeg,jpg,png|max:10240',
			'image_locver_lide_re' => 'nullable|mimes:jpeg,jpg,png|max:10240',
			'image_locver_lide_le' => 'nullable|mimes:jpeg,jpg,png|max:10240',
		];
	}
}
